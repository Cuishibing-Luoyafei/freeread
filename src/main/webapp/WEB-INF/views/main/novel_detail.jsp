	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="novelName"
				disabled="disabled" value="${novelHead.novelName }">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="author"
				disabled="disabled" value="${novelHead.novelAuthor }" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<!-- <button class="btn btn-default" onclick=""> -->
				<a
					href="${pageContext.request.contextPath }/novelChapterList?novelId=${novelHead.novelId }">开始阅读</a>
			<!-- </button> -->
		</div>
	</div>
</form>